...
// Copy-pasted from https://github.com/modelcontextprotocol/typescript-sdk/blob/main/src/mcp_client/types.ts
...
export const ProgressNotificationParamsSchema = NotificationsParamsSchema.merge(
  ProgressSchema,
).extend({
  /**
...
export type CompleteRequestResourceTemplate = ExpandRecursively<
  Omit<CompleteRequest, "params"> & {
    params: Omit<CompleteRequestParams, "ref"> & {
...
export type CompleteRequestPrompt = ExpandRecursively<
  Omit<CompleteRequest, "params"> & {
    params: Omit<CompleteRequestParams, "ref"> & { ref: PromptReference };
  }
>;
